...
DROP TABLE IF EXISTS `ph_cash_banks`;
...
CREATE TABLE `ph_cash_banks` (
  ...
  CONSTRAINT `ph_cash_banks_ibfk_1` FOREIGN KEY (`cashbook_id`) REFERENCES `cashbooks` (`cashbook_id`) ON DELETE SET NULL ON UPDATE CASCADE
...
LOCK TABLES `ph_cash_banks` WRITE;
/*!40000 ALTER TABLE `ph_cash_banks` DISABLE KEYS */;
/*!40000 ALTER TABLE `ph_cash_banks` ENABLE KEYS */;
UNLOCK TABLES;

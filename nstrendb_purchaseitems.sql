...
CREATE TABLE `purchaseitems` (
  ...
  `EndingInventory` int DEFAULT NULL,
  `RequiredBalance` int DEFAULT '0',
  ...
  CONSTRAINT `purchaseitems_ibfk_1` FOREIGN KEY (`PurchaseID`) REFERENCES `purchases` (`PurchaseID`) ON DELETE CASCADE ON UPDATE CASCADE
